! function(t, e) {
    ...
    w.fn.extend({
        ...
        contents: function(t) {
            return null != t.contentDocument && r(t.contentDocument) ? t.contentDocument : (S(t, "template") && (t = t.content || t), w.merge([], t.childNodes))
        }
    }, (function(t, e) {
        w.fn[t] = function(n, r) {
        ...
        Vn = function() {
            ...
            return e.enable = function() {
                ...
                return Object.keys(e).forEach((function(t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), c.typeCheckConfig(Nn, t, this.constructor.DefaultType), t.sanitize && (t.template = An(t.template, t.whiteList, t.sanitizeFn)), t
...
function(t, e) {
    ...
    return function(t) {
        ...
        v.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">', '<a class="ql-close"></a>', "</div>"].join(""), e.BubbleTooltip = v, e.default = m
    }, function(t, e, n) {
        "use strict";
        ...
        b.TEMPLATE = ['<a class="ql-preview" rel="noopener noreferrer" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""), e.default = g
    }]).default
...
if (document.querySelector("#ai-form") && (document.querySelector("#ai-form-show-button") && document.querySelector("#ai-form-show-button").addEventListener("click", (function() {
    ...
    }))), document.querySelector("#template-filters")) {
    let t = (t, e) => {
        let n = t => {
                document.querySelector('[data-category-label="' + t + '"]').classList.remove("d-none")
            },
            r = t => {
                document.querySelector('[data-template="' + t + '"]').classList.remove("d-none")
            },
            o = e ? document.querySelectorAll('[data-template-category="' + e + '"]') : document.querySelectorAll("[data-template]");
        t || e ? (document.querySelectorAll("[data-category-label]").forEach((function(t) {
            t.classList.add("d-none")
        })), document.querySelectorAll("[data-template]").forEach((function(t) {
            t.classList.add("d-none")
        })), o.forEach((function(e) {
            t ? e.dataset.template.toLowerCase().includes(t.toLowerCase()) && (r(e.dataset.template), n(e.dataset.templateCategory)) : (r(e.dataset.template), n(e.dataset.templateCategory))
    ...
    document.querySelectorAll("[data-filter-category]").forEach((function(e) {
    ...
    })), document.querySelector("#form-templates-search") && (document.querySelector("#i-search").addEventListener("keyup", (function() {
        ...
        document.querySelector("#i-search").value = "", document.querySelector("#i-search").focus(), document.querySelector("#form-templates-search").append(document.querySelector("#clear-button-container")), document.querySelector("#clear-button-container").classList.add("d-none"), t("", document.querySelector("[data-filter-category-active]").dataset.filterCategoryActive)
    })))
}
...
if (loadEditor(), document.querySelector("#form-chat")) {
    let t = () => {
        ...
        n = () => {
            document.querySelector("#i-message").value = "", document.querySelector("#i-message").removeAttribute("style")
        },
        r = () => {
    ...
    setTimeout((function() {
        t()
    }), 100), e(), document.querySelector("#i-message").addEventListener("keypress", (function(t) {
        13 !== t.which || t.shiftKey || (t.preventDefault(), document.querySelector('#form-chat button[name="submit"]').click())
    })), document.querySelector("#form-chat").addEventListener("submit", (function(t) {
        t.preventDefault(), s()
    }));
    let s = () => {
        ...
        fetch(document.querySelector("#form-chat").getAttribute("action"), {
            ...
            document.querySelector("#chat-messages").innerHTML += r.message, t(), document.querySelectorAll('#chat-messages a[data-toggle="modal"]').forEach((function(t) {
                confirmationModalEvent(t)
            ...
            fetch(document.querySelector("#form-chat").getAttribute("action"), {
                ...
                if (r.errors) return i(r.errors.message[0]), o(), l(document.querySelector('#form-chat button[type="submit"]')), !1;
                document.querySelector("#chat-messages").innerHTML += r.message, t(), e(), n(), o(), l(document.querySelector('#form-chat button[type="submit"]')), document.querySelectorAll('#chat-messages a[data-toggle="modal"]').forEach((function(t) {
                    confirmationModalEvent(t)
                })), jQuery('#chat-messages [data-tooltip="true"]').tooltip({
                    animation: !0,
                    trigger: "hover",
